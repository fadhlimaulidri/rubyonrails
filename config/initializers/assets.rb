...
Rails.application.config.assets.precompile += %w( fontawesome-webfont.eot fontawesome-webfont.svg fontawesome-webfont.ttf fontawesome-webfont.woff fontawesome-webfont.woff2 FontAwesome.otf Simple-Line-Icons.dev.svg Simple-Line-Icons.eot Simple-Line-Icons.svg Simple-Line-Icons.ttf Simple-Line-Icons.woff Simple-Line-Icons.woff2 weathericons-regular-webfont.eot weathericons-regular-webfont.svg weathericons-regular-webfont.ttf weathericons-regular-webfont.woff weathericons-regular-webfont.woff2 jquery.js material/moment.js bootstrap.js application.css bootstrap.css font-awesome.css home.scss lineicons.css mystyles.css weather-icons.css)
